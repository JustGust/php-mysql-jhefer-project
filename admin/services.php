            ...
            <aside class="lg-side">
                ...
                ?>
                            ...
                            <tr class="">
                                ...
                                <td class="inbox-small-cells"><a href="./services.php?id=<?= $data->id ?>"
                                        class="btn btn-success"><i class="fa fa-edit"></i></a></td>
                                <td class="inbox-small-cells"><a href="../controller/deleteService.php?id=<?= $data->id ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a></td>
                ...
                <div id="modal" class="modal">
                    <div class="modal-content">
                        ...
                        <form action="../controller/registerService.php" method="POST">
                            <div class="form-group">
                                <input type="text" class="form-control" name="name_services" placeholder="Nombre"
                                    aria-describedby="basic-addon1" required>
                            </div>
                            <div class="form-group">
                                <textarea class="form-control" name="description_services" placeholder="Descripción"
                ...
                <div id="modalUpdate" class="modal">
                    <div class="modal-content">
                        ...
                        <form action="../controller/updateService.php" method="POST">
                            <?php
                                $sqlUpdate=$mysqli->query("SELECT * FROM services WHERE id='$_GET[id]'");
                                $data = $sqlUpdate->fetch_object();
                              ?>
                            <div class="form-group">
                                <input type="text" class="form-control" value="<?= $data->name ?>" name="name_services"
                            ...
                            <input type="hidden" name="id_services" value="<?= $data->id ?>">
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary btn-block">Guardar</button>
                            </div>
                        </form>
